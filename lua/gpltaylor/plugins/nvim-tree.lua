return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>tff", "<cmd>NvimTreeFindFileToggle<CR>", { desc = "Toggle file explorer on current file" }) -- toggle file explorer on current file
    ...
    keymap.set("n", "<leader>tf", "<cmd>NvimTreeFocus<CR>", { desc = "Focus on Tree" })                                  -- refresh file explorer
  end
}
